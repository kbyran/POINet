...
class Module(BaseModule):
    ...
    def __init__(self, symbol, data_names=None, label_names=None,
                 ...
                 fixed_param=None, excluded_param=None, state_names=None,
    ...
    def fit(self, train_data, eval_data=None, eval_metric='acc',
        ...
        Checkout `Module Tutorial
        <https://mxnet.apache.org/api/python/tutorials/packages/module/index.html>`_
        ...
        self.logger.info("MEM usage: {} MiB".format(
            int(self._exec_group.execs[0].debug_str().split('\n')[-3].split()[1])))
